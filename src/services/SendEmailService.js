...
var SendEmailService = /** @class */ (function () {
    ...
    SendEmailService.getInstance = function () {
    ...
    ========================================================================*/
    SendEmailService.prototype.sendEmail = function (emailData) {
        return __awaiter(this, void 0, void 0, function () {
            var email, info, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        email = __assign(__assign({}, this.emailData), emailData);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                    ...
                    case 2:
                        info = _a.sent();
                        return [2 /*return*/, 'Message sent: %s' + info.messageId];
                    case 3:
                        error_1 = _a.sent();
                        return [2 /*return*/, 'Error sending email: %s' + error_1];
